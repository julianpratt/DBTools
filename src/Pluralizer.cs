...
{
    /// <summary>
    /// Class to pluralize a word based on standard English Pluralization Rules (ha ha).
    /// </summary>
    public static class Pluralizer
    {
        // Based on https://github.com/mattgrande/Grande.Pluralizer
        ...
        {
            if (singular.Trim().Length == 0)        return singular;

            if (Unpluralizables.Contains(singular)) return singular;
